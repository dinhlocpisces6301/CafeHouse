                ...
                <form method="post" onsubmit="return validateForm();">
                    <div class="form-group">
                        ...
                        <input required="true" type="text" class="form-control" id="usr" name="fullname"
                            value="<?=$fullname?>" style="width: 300px;">
                        <input type="text" name="id" value="<?=$id?>" hidden="true">
                    </div>
                    </br>

                    <div class="form-group">
                        <label for="usr">Vai trò:</label>
                        <select class="form-control" name="role_id" id="role_id" required="true" style="width: 300px;">
                    ...
                    <div class="form-group">
                        ...
                        <input required="true" type="tel" class="form-control" id="phone_number" name="phone_number"
                            value="<?=$phone_number?>" style="width: 300px;">
                    </div>
                    </br>
                    ...
                    <div class="form-group">
                        ...
                        <input required="true" type="text" class="form-control" id="address" name="address"
                            value="<?=$address?>" style="width: 500px;">
                    </div>
                    </br>
                    ...
                    <div class="form-group">
                        ...
                        <input <?=($id > 0?'':'required="true"')?> type="password" class="form-control" id="pwd"
                            name="password" minlength="6" style="width: 300px;">
                    </div>
                    </br>
                    ...
                    <div class="form-group">
                        ...
                        <input <?=($id > 0?'':'required="true"')?> type="password" class="form-control"
                            id="confirmation_pwd" minlength="6" style="width: 300px;">
                    </div>
                    </br>
